...
class NoteCoreDataHelper {
    ...
    static func readNotesFromCoreData(fromManagedObjectContext: NSManagedObjectContext) -> [NoteModel] {

        var returnedNotes = [NoteModel]()
        ...
        do {
            ...
            fetchedNotesFromCoreData.forEach { (fetchRequestResult) in
                ...
                returnedNotes.append(NoteModel.init(
